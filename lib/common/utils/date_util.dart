...
import '../extension/date/datetime_formatter.dart';
...
class _TimeConstants {
  ...
  static const int millisecondsPerWeek = daysPerWeek *
      hoursPerDay *
      minutesPerHour *
      secondsPerMinute *
  ...
  static bool isWeek(int? ms, {bool isUtc = false, int? locMs}) {
    ...
    return (now.weekday >= old.weekday) &&
        (now.millisecondsSinceEpoch - old.millisecondsSinceEpoch <=
            _TimeConstants.millisecondsPerWeek);
  }

  /// 是否同年同月
  static bool isSameYearMonth(DateTime dateTime, DateTime locDateTime) {
    return dateTime.year == locDateTime.year &&
        dateTime.month == locDateTime.month;
  }

  /// 是否同月
  static bool isSameMonth(DateTime dateTime, DateTime locDateTime) {
